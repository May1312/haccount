...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="appVersionList" title="App版本升级" actionUrl="appVersionController.do?datagrid" idField="id"
                    fit="true">
            ...
            <t:dgDelOpt title="删除" url="appVersionController.do?del&id={id}" urlclass="ace_button"
                        urlfont="fa-trash-o"/>
            <t:dgToolBar title="录入" icon="icon-add" url="appVersionController.do?addorupdate"
                         funname="add"></t:dgToolBar>
            <t:dgToolBar title="编辑" icon="icon-edit" url="appVersionController.do?addorupdate"
                         funname="update"></t:dgToolBar>
            <t:dgToolBar title="查看" icon="icon-search" url="appVersionController.do?addorupdate"

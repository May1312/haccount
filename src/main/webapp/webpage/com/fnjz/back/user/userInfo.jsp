        ...
        <tr>
            ...
            <td class="value">
                <input class="Wdate" onClick="WdatePicker()" style="width: 150px" id="birthday" name="birthday"
                       ignore="ignore"
                       value="<fmt:formatDate value='${userInfoPage.birthday}' type="date" pattern="yyyy-MM-dd"/>"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
            <%--<tr>
        ...
        <tr>
            ...
            <td class="value">
                <input class="inputxt" id="constellation" name="constellation" ignore="ignore"
                       value="${userInfoPage.constellation}" datatype="n"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
        <tr>
            ...
            <td class="value">
                <input class="inputxt" id="mobileSystem" name="mobileSystem" ignore="ignore"
                       value="${userInfoPage.mobileSystem}"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
            <%--<tr>
        ...
        <tr>
            ...
            <td class="value">
                <input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="width: 150px"
                       ...
                       value="<fmt:formatDate value='${userInfoPage.registerDate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>"
                       datatype="*"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>

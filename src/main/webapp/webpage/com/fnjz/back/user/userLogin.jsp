...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userLoginController.do?save">
    ...
    <table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
        ...
        <tr>
            ...
            <td class="value">
                <input class="inputxt" id="gesturePw" name="gesturePw" ignore="ignore"
                       value="${userLoginPage.gesturePw}"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
        <tr>
            ...
            <td class="value">
                <input class="inputxt" id="gesturePwType" name="gesturePwType" ignore="ignore"
                       value="${userLoginPage.gesturePwType}"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="value">
                <input class="inputxt" id="wechatAuth" name="wechatAuth" ignore="ignore"
                       value="${userLoginPage.wechatAuth}"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
        <tr>
            ...
            <td class="value">
                <input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="width: 150px"
                       id="registerDate" name="registerDate" ignore="ignore"
                       value="<fmt:formatDate value='${userLoginPage.registerDate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
        <tr>
            ...
            <td class="value">
                <input class="inputxt" id="userInfoId" name="userInfoId" value="${userLoginPage.userInfoId}"
                       datatype="*"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>

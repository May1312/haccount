...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="spendTypeList" title="支出标签管理" actionUrl="spendTypeController.do?datagrid&labelGrade=3" idField="id"
                    fit="true" queryMode="group">
            <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
            <t:dgCol title="支出类目名称" field="spendName" width="120" query="true"></t:dgCol>
            <t:dgCol title="父级类目" field="parentId" width="120" query="true"></t:dgCol>
            ...
            <t:dgCol title="常用字段,0:非常用,1:常用" field="mark" width="120"></t:dgCol>

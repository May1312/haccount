...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="channelList" title="渠道" actionUrl="channelController.do?datagrid" idField="id" fit="true"
                    queryMode="group">
            ...
            <t:dgToolBar title="编辑" icon="icon-edit" url="channelController.do?addorupdate"
                         funname="update"></t:dgToolBar>
            <t:dgToolBar title="查看" icon="icon-search" url="channelController.do?addorupdate"

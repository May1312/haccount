...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="incomeTypeList" title="收入标签管理" actionUrl="incomeTypeController.do?datagrid&labelGrade=3" idField="id"
                    fit="true" queryMode="group">
            <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
            <t:dgCol title="收入类目名称" field="incomeType" width="120" query="true"></t:dgCol>
            <t:dgCol title="收入父级类目" field="parentId" width="120" query="true"></t:dgCol>

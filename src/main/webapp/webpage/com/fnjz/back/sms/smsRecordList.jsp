...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="smsRecordList" title="短信发送记录" actionUrl="smsRecordController.do?datagrid" idField="id"
            ...
            <t:dgCol title="模板id" field="sendTemplateCode" width="120"></t:dgCol>
            ...
            <t:dgCol title="模板内容" field="remark" width="120"></t:dgCol>
            <t:dgCol title="操作" field="opt" width="100"></t:dgCol>
            <t:dgDelOpt title="删除" url="smsRecordController.do?del&id={id}" urlclass="ace_button" urlfont="fa-trash-o"/>
            <t:dgToolBar title="录入" icon="icon-add" url="smsRecordController.do?addorupdate"
                         funname="add"></t:dgToolBar>
            <t:dgToolBar title="编辑" icon="icon-edit" url="smsRecordController.do?addorupdate"
                         funname="update"></t:dgToolBar>
            <t:dgToolBar title="查看" icon="icon-search" url="smsRecordController.do?addorupdate"

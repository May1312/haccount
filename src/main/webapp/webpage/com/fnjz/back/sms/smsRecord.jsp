    ...
    <table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
        ...
        <tr>
            ...
            <td class="value">
                ...
                <select class="selectxt" id="terminaltype" name="terminaltype" ignore="ignore"
                        value="${smsRecordPage.terminaltype}">
                    <option value="">不限</option>
                    <option value="android" <c:if
                            test="${smsRecordPage.terminaltype eq 'android'}"> selected="selected"</c:if>>android
                    </option>
                    <option value="ios" <c:if test="${smsRecordPage.terminaltype eq 'ios'}"> selected="selected"</c:if>>
                        ios
                    </option>
                    <option value="all" <c:if test="${smsRecordPage.terminaltype eq 'all'}"> selected="selected"</c:if>>
                        全部
                    </option>
                </select>
        ...
        <tr>
            ...
            <td class="value">
                <input class="inputxt" id="sendmobile" name="sendmobile" ignore="ignore"
                       value="${smsRecordPage.sendmobile}" placeholder="多个按逗号分隔"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
        <tr>
            ...
            <td class="value">
                <input class="inputxt" id="sendTemplateCode" name="sendTemplateCode"
                       value="${smsRecordPage.sendTemplateCode}" datatype="s"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="value">
                <input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'%y-%M-{%d}'})"
                       style="width: 150px" id="sendtime" name="sendtime" datatype="*"
                       value="<fmt:formatDate value='${smsRecordPage.sendtime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
            <%--<tr>

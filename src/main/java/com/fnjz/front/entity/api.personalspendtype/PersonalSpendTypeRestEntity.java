package com.fnjz.front.entity.api.personalspendtype;
 ...
 */
@Entity
@Table(name = "hbird_personal_spend_type", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class PersonalSpendTypeRestEntity implements java.io.Serializable {
	/**类目id*/
	...
	/**系统表父类目id*/
	private java.lang.String sysSpendTypePid;
	/**图标*/
	 ...
	 */
	@Column(name ="SYS_SPEND_TYPE_PID",nullable=true,length=36)
	public java.lang.String getSysSpendTypePid(){
		return this.sysSpendTypePid;
	}
	 ...
	 */
	public void setSysSpendTypePid(java.lang.String sysSpendTypePid){
		this.sysSpendTypePid = sysSpendTypePid;
	}
	/**
	 *方法: 取得java.lang.String

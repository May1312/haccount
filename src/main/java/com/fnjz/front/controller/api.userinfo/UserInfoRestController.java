        ...
        try {
            ...
            if(StringUtils.isNotEmpty(userInfoRestEntity.getAvatarUrl())){
                ...
                if(StringUtils.contains(userInfoRestEntity.getAvatarUrl(),".clouddn.com")){
                    ...
                    //新版追加域名
                    if(!StringUtils.contains(userInfoRestEntity.getAvatarUrl(),"http")){
                        userInfoRestEntity.setAvatarUrl(DomainEnum.HEAD_PICTURE_DOMAIN.getDomainUrl()+userInfoRestEntity.getAvatarUrl());
                    }
                }
            }

...
public interface AccountBookTypeRestDao {
    ...
    @Sql("select id,ab_type_name,icon_describe,type_budget from hbird_account_book_type where status=1 order by priority desc;")

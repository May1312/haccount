...
public interface WarterOrderRestDao {
    ...
    @Sql("INSERT INTO `hbird_water_order` ( `id`, `account_book_id`, `money`, `order_type`, `is_staged`, `spend_happiness`, `type_pid`, `type_id`, `type_name`, `create_date`, `charge_date`, `delflag`, `create_by`, `update_by`, `create_name`, `remark`, `user_private_label_id`,`icon`,`update_date`,`client_id` ) VALUES ( UUID( ), :charge.accountBookId, :charge.money, :charge.orderType, :charge.isStaged, :charge.spendHappiness, :charge.typePid, :charge.typeId, :charge.typeName, NOW(), :charge.chargeDate, :charge.delflag, :charge.createBy,:charge.updateBy, :charge.createName, :charge.remark, :charge.userPrivateLabelId,:charge.icon,:charge.updateDate,:charge.clientId);")
     ...
     * @return
     */
    @Sql("SELECT base1.id, base1.money, base1.order_type, base1.spend_happiness, base1.type_name, base1.remark, base1.icon, base1.user_private_label_id, base1.charge_date,base1.create_date,base1.update_date,base1.update_by, base3.ab_name,base3.account_book_type_id as abTypeId,base1.assets_id,base1.assets_name FROM hbird_water_order AS base1 LEFT JOIN hbird_account_book AS base3 ON base1.account_book_id = base3.id WHERE base1.id = :id;")

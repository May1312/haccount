...
public interface WarterOrderRestDao {
    ...
    @Sql("INSERT INTO `hbird_water_order` ( `id`, `account_book_id`, `money`, `order_type`, `is_staged`, `spend_happiness`, `type_pid`, `type_id`, `type_name`, `create_date`, `charge_date`, `delflag`, `create_by`, `update_by`, `create_name`, `remark`, `user_private_label_id`,`icon`,`update_date` ) VALUES ( UUID( ), :charge.accountBookId, :charge.money, :charge.orderType, :charge.isStaged, :charge.spendHappiness, :charge.typePid, :charge.typeId, :charge.typeName, NOW(), :charge.chargeDate, :charge.delflag, :charge.createBy,:charge.updateBy, :charge.createName, :charge.remark, :charge.userPrivateLabelId,:charge.icon,:charge.updateDate);")

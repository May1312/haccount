...
public class DySmsDemo {
    ...
    public static SendSmsResponse sendSms() throws ClientException {
        ...
        //必填:待发送手机号
        request.setPhoneNumbers("15712878576");
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("蜂鸟记账");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_136025283");
    ...
    public static SendBatchSmsResponse batchSendSms() throws ClientException {
        //设置超时时间-可自行调整
        System.setProperty("sun.net.client.defaultConnectTimeout", "10000");
        System.setProperty("sun.net.client.defaultReadTimeout", "10000");
        //初始化ascClient需要的几个参数
        ...
        request.setPhoneNumberJson("[\"15712878576\",\"15712878158\"]");
        //必填:短信签名-支持不同的号码发送不同的短信签名
        request.setSignNameJson("[\"蜂鸟记账\",\"蜂鸟记账\"]");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_136000280");
        //必填:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
        //友情提示:如果JSON中需要带换行符,请参照标准的JSON协议对换行符的要求,比如短信内容中包含\r\n的情况在JSON中需要表示成\\r\\n,否则会导致JSON在服务端解析失败
        request.setTemplateParamJson("[{\"mtname\":\"Tom\", \"submittime\":\"123\"},{\"name\":\"mtname\", \"submittime\":\"456\"}]");
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber("15712878576");
        //可选-流水号
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
        ...
        //批量发送
        /*SendBatchSmsResponse sendBatchSmsResponse = batchSendSms();
        System.out.println("短信接口返回的数据----------------");
        System.out.println("Code=" + sendBatchSmsResponse.getCode());

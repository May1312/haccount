...
public enum ApiResultType {
    ...
    UNIONID_IS_NULL("01034","未获取到登录信息，请重新授权"),
    ...
    GESTURE_UPDATE_ERROR("02002","手势密码修改失败，请重试"),
